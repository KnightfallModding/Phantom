...
{
    public const User32.VirtualKey IM_VK_KEYPAD_ENTER = (User32.VirtualKey)(
        (int)User32.VirtualKey.VK_RETURN + 256
    );
    ...
    private static bool ImGui_ImplWin32_InitEx(void* windowHandle, bool platform_has_own_dc)
    {
        ...
        ImGui.GetMainViewport().Handle->PlatformHandleRaw = windowHandle;
        ...
        for (var n = 0; n < xinput_dll_names.Count; n++)
        {
            ...
            if (dll != IntPtr.Zero)
            {
                ...
                _xInputGetCapabilities =
                    Marshal.GetDelegateForFunctionPointer<XInputGetCapabilitiesDelegate>(
                        Kernel32.GetProcAddress(dll, "XInputGetCapabilities")
                    );
                _xInputGetState = Marshal.GetDelegateForFunctionPointer<XInputGetStateDelegate>(
                    Kernel32.GetProcAddress(dll, "XInputGetState")
                );
                break;
            }
        }
    ...
    private static void ImGui_ImplWin32_AddKeyEvent(
        ImGuiKey key,
        bool down,
        User32.VirtualKey native_keycode,
    ...
    public static void ImGui_ImplWin32_UpdateMouseData()
    {
        ...
        var focused_window = User32.GetForegroundWindow();
        var is_app_focused = focused_window == _windowHandle;
        if (is_app_focused)
        {
    ...
    public static void NewFrame()
    {
        ...
        var mouse_cursor = io.MouseDrawCursor ? ImGuiMouseCursor.None : ImGui.GetMouseCursor();
    ...
    public static ImGuiKey ImGui_ImplWin32_VirtualKeyToImGuiKey(User32.VirtualKey wParam)
    {
        switch (wParam)
        {
            case User32.VirtualKey.VK_TAB:
                return ImGuiKey.Tab;
            case User32.VirtualKey.VK_LEFT:
                return ImGuiKey.LeftArrow;
            case User32.VirtualKey.VK_RIGHT:
                return ImGuiKey.RightArrow;
            case User32.VirtualKey.VK_UP:
                return ImGuiKey.UpArrow;
            case User32.VirtualKey.VK_DOWN:
                return ImGuiKey.DownArrow;
            case User32.VirtualKey.VK_PRIOR:
                return ImGuiKey.PageUp;
            case User32.VirtualKey.VK_NEXT:
                return ImGuiKey.PageDown;
            case User32.VirtualKey.VK_HOME:
                return ImGuiKey.Home;
            case User32.VirtualKey.VK_END:
                return ImGuiKey.End;
            case User32.VirtualKey.VK_INSERT:
                return ImGuiKey.Insert;
            case User32.VirtualKey.VK_DELETE:
                return ImGuiKey.Delete;
            case User32.VirtualKey.VK_BACK:
                return ImGuiKey.Backspace;
            case User32.VirtualKey.VK_SPACE:
                return ImGuiKey.Space;
            case User32.VirtualKey.VK_RETURN:
                return ImGuiKey.Enter;
            case User32.VirtualKey.VK_ESCAPE:
                return ImGuiKey.Escape;
            case User32.VirtualKey.VK_OEM_7:
                return ImGuiKey.Apostrophe;
            case User32.VirtualKey.VK_OEM_COMMA:
                return ImGuiKey.Comma;
            case User32.VirtualKey.VK_OEM_MINUS:
                return ImGuiKey.Minus;
            case User32.VirtualKey.VK_OEM_PERIOD:
                return ImGuiKey.Period;
            case User32.VirtualKey.VK_OEM_2:
                return ImGuiKey.Slash;
            case User32.VirtualKey.VK_OEM_1:
                return ImGuiKey.Semicolon;
            case User32.VirtualKey.VK_OEM_PLUS:
                return ImGuiKey.Equal;
            case User32.VirtualKey.VK_OEM_4:
                return ImGuiKey.LeftBracket;
            case User32.VirtualKey.VK_OEM_5:
                return ImGuiKey.Backslash;
            case User32.VirtualKey.VK_OEM_6:
                return ImGuiKey.RightBracket;
            case User32.VirtualKey.VK_OEM_3:
                return ImGuiKey.GraveAccent;
            case User32.VirtualKey.VK_CAPITAL:
                return ImGuiKey.CapsLock;
            case User32.VirtualKey.VK_SCROLL:
                return ImGuiKey.ScrollLock;
            case User32.VirtualKey.VK_NUMLOCK:
                return ImGuiKey.NumLock;
            case User32.VirtualKey.VK_SNAPSHOT:
                return ImGuiKey.PrintScreen;
            case User32.VirtualKey.VK_PAUSE:
                return ImGuiKey.Pause;
            case User32.VirtualKey.VK_NUMPAD0:
                return ImGuiKey.Keypad0;
            case User32.VirtualKey.VK_NUMPAD1:
                return ImGuiKey.Keypad1;
            case User32.VirtualKey.VK_NUMPAD2:
                return ImGuiKey.Keypad2;
            case User32.VirtualKey.VK_NUMPAD3:
                return ImGuiKey.Keypad3;
            case User32.VirtualKey.VK_NUMPAD4:
                return ImGuiKey.Keypad4;
            case User32.VirtualKey.VK_NUMPAD5:
                return ImGuiKey.Keypad5;
            case User32.VirtualKey.VK_NUMPAD6:
                return ImGuiKey.Keypad6;
            case User32.VirtualKey.VK_NUMPAD7:
                return ImGuiKey.Keypad7;
            case User32.VirtualKey.VK_NUMPAD8:
                return ImGuiKey.Keypad8;
            case User32.VirtualKey.VK_NUMPAD9:
                return ImGuiKey.Keypad9;
            case User32.VirtualKey.VK_DECIMAL:
                return ImGuiKey.KeypadDecimal;
            case User32.VirtualKey.VK_DIVIDE:
                return ImGuiKey.KeypadDivide;
            case User32.VirtualKey.VK_MULTIPLY:
                return ImGuiKey.KeypadMultiply;
            case User32.VirtualKey.VK_SUBTRACT:
                return ImGuiKey.KeypadSubtract;
            case User32.VirtualKey.VK_ADD:
                return ImGuiKey.KeypadAdd;
            case IM_VK_KEYPAD_ENTER:
                return ImGuiKey.KeypadEnter;
            case User32.VirtualKey.VK_LSHIFT:
                return ImGuiKey.LeftShift;
            case User32.VirtualKey.VK_LCONTROL:
                return ImGuiKey.LeftCtrl;
            case User32.VirtualKey.VK_LMENU:
                return ImGuiKey.LeftAlt;
            case User32.VirtualKey.VK_LWIN:
                return ImGuiKey.LeftSuper;
            case User32.VirtualKey.VK_RSHIFT:
                return ImGuiKey.RightShift;
            case User32.VirtualKey.VK_RCONTROL:
                return ImGuiKey.RightCtrl;
            case User32.VirtualKey.VK_RMENU:
                return ImGuiKey.RightAlt;
            case User32.VirtualKey.VK_RWIN:
                return ImGuiKey.RightSuper;
            case User32.VirtualKey.VK_APPS:
                return ImGuiKey.Menu;
            case (User32.VirtualKey)'0':
                return ImGuiKey.Key0;
            case (User32.VirtualKey)'1':
                return ImGuiKey.Key1;
            case (User32.VirtualKey)'2':
                return ImGuiKey.Key2;
            case (User32.VirtualKey)'3':
                return ImGuiKey.Key3;
            case (User32.VirtualKey)'4':
                return ImGuiKey.Key4;
            case (User32.VirtualKey)'5':
                return ImGuiKey.Key5;
            case (User32.VirtualKey)'6':
                return ImGuiKey.Key6;
            case (User32.VirtualKey)'7':
                return ImGuiKey.Key7;
            case (User32.VirtualKey)'8':
                return ImGuiKey.Key8;
            case (User32.VirtualKey)'9':
                return ImGuiKey.Key9;
            case (User32.VirtualKey)'A':
                return ImGuiKey.A;
            case (User32.VirtualKey)'B':
                return ImGuiKey.B;
            case (User32.VirtualKey)'C':
                return ImGuiKey.C;
            case (User32.VirtualKey)'D':
                return ImGuiKey.D;
            case (User32.VirtualKey)'E':
                return ImGuiKey.E;
            case (User32.VirtualKey)'F':
                return ImGuiKey.F;
            case (User32.VirtualKey)'G':
                return ImGuiKey.G;
            case (User32.VirtualKey)'H':
                return ImGuiKey.H;
            case (User32.VirtualKey)'I':
                return ImGuiKey.I;
            case (User32.VirtualKey)'J':
                return ImGuiKey.J;
            case (User32.VirtualKey)'K':
                return ImGuiKey.K;
            case (User32.VirtualKey)'L':
                return ImGuiKey.L;
            case (User32.VirtualKey)'M':
                return ImGuiKey.M;
            case (User32.VirtualKey)'N':
                return ImGuiKey.N;
            case (User32.VirtualKey)'O':
                return ImGuiKey.O;
            case (User32.VirtualKey)'P':
                return ImGuiKey.P;
            case (User32.VirtualKey)'Q':
                return ImGuiKey.Q;
            case (User32.VirtualKey)'R':
                return ImGuiKey.R;
            case (User32.VirtualKey)'S':
                return ImGuiKey.S;
            case (User32.VirtualKey)'T':
                return ImGuiKey.T;
            case (User32.VirtualKey)'U':
                return ImGuiKey.U;
            case (User32.VirtualKey)'V':
                return ImGuiKey.V;
            case (User32.VirtualKey)'W':
                return ImGuiKey.W;
            case (User32.VirtualKey)'X':
                return ImGuiKey.X;
            case (User32.VirtualKey)'Y':
                return ImGuiKey.Y;
            case (User32.VirtualKey)'Z':
                return ImGuiKey.Z;
            case User32.VirtualKey.VK_F1:
                return ImGuiKey.F1;
            case User32.VirtualKey.VK_F2:
                return ImGuiKey.F2;
            case User32.VirtualKey.VK_F3:
                return ImGuiKey.F3;
            case User32.VirtualKey.VK_F4:
                return ImGuiKey.F4;
            case User32.VirtualKey.VK_F5:
                return ImGuiKey.F5;
            case User32.VirtualKey.VK_F6:
                return ImGuiKey.F6;
            case User32.VirtualKey.VK_F7:
                return ImGuiKey.F7;
            case User32.VirtualKey.VK_F8:
                return ImGuiKey.F8;
            case User32.VirtualKey.VK_F9:
                return ImGuiKey.F9;
            case User32.VirtualKey.VK_F10:
                return ImGuiKey.F10;
            case User32.VirtualKey.VK_F11:
                return ImGuiKey.F11;
            case User32.VirtualKey.VK_F12:
                return ImGuiKey.F12;
            default:
    ...
    public static bool WndProcHandler(IntPtr hwnd, WindowMessage msg, IntPtr wParam, IntPtr lParam)
    {
        ...
        switch (msg)
        {
            ...
            case WindowMessage.WM_NCMOUSEMOVE:
            {
                ...
                var area = msg == WindowMessage.WM_MOUSEMOVE ? 1 : 2;
                _mouseHandle = hwnd;
                if (_mouseTrackedArea != area)
                {
                    User32.TRACKMOUSEEVENT tme_cancel = new(User32.TMEFlags.TME_CANCEL, hwnd, 0);
                    User32.TRACKMOUSEEVENT tme_track = new(
                        area == 2
                            ? User32.TMEFlags.TME_LEAVE | User32.TMEFlags.TME_NONCLIENT
                            : User32.TMEFlags.TME_LEAVE,
                        hwnd,
                        0
                    );
            ...
            {
                var area = msg == WindowMessage.WM_MOUSELEAVE ? 1 : 2;
                if (_mouseTrackedArea == area)
                {
            ...
            {
                var is_key_down =
                    msg == WindowMessage.WM_KEYDOWN || msg == WindowMessage.WM_SYSKEYDOWN;
                if ((int)wParam < 256)
                {
                    // Submit modifiers
                    ...
                    var vk = (User32.VirtualKey)wParam;

                    var isEnter = (User32.VirtualKey)wParam == User32.VirtualKey.VK_RETURN;
                    ...
                    if (vk == User32.VirtualKey.VK_SHIFT)
                    {
                        ...
                        if (IsVkDown(User32.VirtualKey.VK_LSHIFT) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.LeftShift,
                                is_key_down,
                                User32.VirtualKey.VK_LSHIFT,
                                scancode
                            );
                        }

                        if (IsVkDown(User32.VirtualKey.VK_RSHIFT) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.RightShift,
                                is_key_down,
                                User32.VirtualKey.VK_RSHIFT,
                                scancode
                            );
                        }
                    }
                    ...
                    {
                        if (IsVkDown(User32.VirtualKey.VK_LCONTROL) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.LeftCtrl,
                                is_key_down,
                                User32.VirtualKey.VK_LCONTROL,
                                scancode
                            );
                        }

                        if (IsVkDown(User32.VirtualKey.VK_RCONTROL) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.RightCtrl,
                                is_key_down,
                    ...
                    {
                        if (IsVkDown(User32.VirtualKey.VK_LMENU) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.LeftAlt,
                                is_key_down,
                                User32.VirtualKey.VK_LMENU,
                                scancode
                            );
                        }

                        if (IsVkDown(User32.VirtualKey.VK_RMENU) == is_key_down)
                        {
                            ImGui_ImplWin32_AddKeyEvent(
                                ImGuiKey.RightAlt,
                                is_key_down,
    ...
    private static bool _IsWindowsVersionOrGreater(short major, short minor, short unused)
    {
        ...
        return
            Ntdll.RtlVerifyVersionInfo(
                &versionInfo,
                VER_MASK.VER_MAJORVERSION | VER_MASK.VER_MINORVERSION,
                (long)conditionMask
            ) == 0
            ? true
            : false;
    ...
    public static float ImGui_ImplWin32_GetDpiScaleForHwnd(void* hwnd)
    {
